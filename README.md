# [Enigmatica 6 1.12.0](https://www.curseforge.com/minecraft/modpacks/enigmatica6) on Curseforge
...
The docker on first run will download the same version as tagged of `Enigmatica 6 1.12.0` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "Enigmatica 6 1.12.0 Server Powered by Docker"
* LEVEL world
