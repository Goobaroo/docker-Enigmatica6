...
if ! [[ -f Enigmatica6Server-1.12.0.zip ]]; then
	...
	curl -Lo Enigmatica6Server-1.12.0.zip 'https://edge.forgecdn.net/files/6881/845/Enigmatica6Server-1.12.0.zip' && unzip -u -o 'Enigmatica6Server-1.12.0.zip' -d /data
