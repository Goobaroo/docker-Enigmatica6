...
if ! [[ -f Enigmatica6Server-1.11.0.zip ]]; then
	...
	curl -Lo Enigmatica6Server-1.11.0.zip 'https://edge.forgecdn.net/files/6695/881/Enigmatica6Server-1.11.0.zip' && unzip -u -o 'Enigmatica6Server-1.11.0.zip' -d /data
